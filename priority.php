...
if (isset($_POST['btnadd'])) {
    ...
    if (!empty($_POST['id'])) {
        try {
            $stmt = $mysqli->prepare("UPDATE priority set name=? WHERE id=?");
        ...
        redirect("?");
            ...
            $stmt = $mysqli->prepare("INSERT into priority (name)values (?)");
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-square btn-outline-danger" data-bs-toggle="modal"
                            data-bs-target=".bd-example-modal-lg">Add Priority</button>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php
                        $stmt = $mysqli->prepare("SELECT * from  priority  order by id desc");
                        $stmt->execute();
                        $res = $stmt->get_result();
                        $sno = 1;
        ...
        <div class="modal-dialog  modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title fs-5" id="exampleModalLabel"> <span class="btnname"> Add priority</span></h3>
