            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Sub Category Report</h4>                      
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>                              
                                <?php
                                    $stmt = $mysqli->prepare("SELECT a.*,sum(b.price*b.qty) as price,sum(b.commision) as commision  from  sub_category  a join order_det b on a.name=b.sub_category group by a.id");
                                    $stmt->execute();
                                    $res = $stmt->get_result();
                                    $sno = 1;
