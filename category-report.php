                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>                              
                                <?php
                                    $stmt = $mysqli->prepare("SELECT a.*,sum(b.price*b.qty) as price,sum(b.commision) as commision from  category  a join order_det b on a.name=b.category group by a.id");
                                    $stmt->execute();
                                    $res = $stmt->get_result();
                                    $sno = 1;
