                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-pills flex-column flex-sm-row">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='bx bx-group me-1'></i> Active</a></li>
                            <li class="nav-item"><a class="nav-link" href="inactive-users.php"><i class='bx bx-group me-1'></i> In Active </a></li>
